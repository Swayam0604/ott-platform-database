...
CREATE TABLE `casts` (
  `Cast_Id` varchar(12) NOT NULL,
  `Role_Id` varchar(12) DEFAULT NULL,
  `Cast_First_Name` varchar(15) DEFAULT NULL,
  `Cast_Last_Name` varchar(15) DEFAULT NULL,
  `About_cast` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`Cast_Id`),
  KEY `Role_Id` (`Role_Id`),
  CONSTRAINT `casts_ibfk_1` FOREIGN KEY (`Role_Id`) REFERENCES `roles` (`Role_Id`)
