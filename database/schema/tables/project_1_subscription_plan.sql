...
CREATE TABLE `subscription_plan` (
  `subscription_plan_Id` varchar(12) NOT NULL,
  `subscription_plan_Name` varchar(20) NOT NULL,
  `subscription_price` decimal(5,2) DEFAULT NULL,
  `device_limit` int NOT NULL,
  `Video_and_sound_Quality` varchar(5) DEFAULT NULL,
  `Resolution` varchar(30) DEFAULT NULL,
  `Supported_Devices` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`subscription_plan_Id`),
  UNIQUE KEY `subscription_plan_Id` (`subscription_plan_Id`),
  UNIQUE KEY `subscription_plan_Name` (`subscription_plan_Name`)
