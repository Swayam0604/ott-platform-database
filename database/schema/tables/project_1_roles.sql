...
CREATE TABLE `roles` (
  ...
  `Charachter_Name` varchar(30) DEFAULT NULL,
  ...
  CONSTRAINT `roles_ibfk_1` FOREIGN KEY (`movie_Id`) REFERENCES `movies` (`Movie_Id`),
  CONSTRAINT `roles_ibfk_2` FOREIGN KEY (`TV_Series_Id`) REFERENCES `tv_series` (`TV_Series_Id`)
