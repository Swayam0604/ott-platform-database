...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_last_login` BEFORE UPDATE ON `user` FOR EACH ROW BEGIN
    IF NEW.is_logged_in = 1 AND OLD.is_logged_in = 0 THEN
