...
CREATE TABLE `devices` (
  ...
  `download_enabled` char(1) NOT NULL,
  `device_status` varchar(20) NOT NULL,
  `Max_download_Limit` int NOT NULL,
  `User_Id` varchar(12) DEFAULT NULL,
  PRIMARY KEY (`Device_Id`),
  UNIQUE KEY `Device_Id` (`Device_Id`),
  UNIQUE KEY `Registered_date` (`Registered_date`),
  KEY `User_Id` (`User_Id`),
  CONSTRAINT `devices_ibfk_1` FOREIGN KEY (`User_Id`) REFERENCES `user` (`User_Id`)
...
-- Dump completed on 2025-09-22 22:54:38
