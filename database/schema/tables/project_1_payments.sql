...
CREATE TABLE `payments` (
  ...
  `Subscription_Id` varchar(12) DEFAULT NULL,
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_payment_insert` AFTER INSERT ON `payments` FOR EACH ROW BEGIN
    ...
    INSERT INTO payment_history (Payment_Id, Payment_history_Id, Payment_status)
    VALUES (NEW.Payment_Id, generate_unique_id('PH'), 'Completed');
END */;;
DELIMITER ;
